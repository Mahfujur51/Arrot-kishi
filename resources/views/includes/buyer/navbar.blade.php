                            ...
                            <ul class="menu" style="list-style: none">
                                ...
                                {{-- <li>
                                    <a href="@if(auth()->user()->role == 'buyer') {{ route('buyer-users.index') }} @else javascript:void(0); @endif">
                                        ...
                                        <div class="menu-info">
                                            <h4>{{ $users->count() }}  new user added</h4>
                                            <p>
                                                <i class="material-icons">access_time</i>@if(isset($users->latest()->first()->created_at)) {{ $users->latest()->first()->created_at->diffForHumans()}} @else 0 @endif mins ago
